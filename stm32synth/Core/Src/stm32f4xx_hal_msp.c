...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, MIXER_FM_DF_Pin|MIXER_PWM_Pin|MIXER_OSC1_FM_Pin|MIXER_OSC1_PM_BETA_Pin
                          |MIXER_OSC2_PM_BETA_Pin);

    HAL_GPIO_DeInit(GPIOA, MIXER_OSC_PMF_Pin|MIXER_FILTER_LOW_Pin|MIXER_FILTER_HIGH_Pin|MIXER_GAIN_Pin
                          |MIXER_OSC2_FM_Pin|MIXER_ATTACK_Pin|MIXER_DECAY_Pin);
