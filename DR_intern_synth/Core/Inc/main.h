...
#define MIXER_OSC_PM_F_Pin GPIO_PIN_4
#define MIXER_OSC_PM_F_GPIO_Port GPIOC
#define MIXER_OSC_PM_PHI_Pin GPIO_PIN_5
#define MIXER_OSC_PM_PHI_GPIO_Port GPIOC
