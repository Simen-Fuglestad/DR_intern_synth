...
#define MIXER_DUTY_CYCLE_Pin GPIO_PIN_1
#define MIXER_DUTY_CYCLE_GPIO_Port GPIOC
#define MIXER_PWM_Pin GPIO_PIN_2
#define MIXER_PWM_GPIO_Port GPIOC
#define MIXER_MOD_Pin GPIO_PIN_3
#define MIXER_MOD_GPIO_Port GPIOC
...
#define MIXER_LFO_2_Pin GPIO_PIN_5
#define MIXER_LFO_2_GPIO_Port GPIOA
...
#define BUTTON_LFO_Pin GPIO_PIN_11
#define BUTTON_LFO_GPIO_Port GPIOD
#define BUTTON_LFO_EXTI_IRQn EXTI15_10_IRQn
#define BUTTON_LFO2_Pin GPIO_PIN_12
#define BUTTON_LFO2_GPIO_Port GPIOD
#define BUTTON_LFO2_EXTI_IRQn EXTI15_10_IRQn
